...
$(function()
{
	...
	{
		$.getJSON( componentsPath + 'maps/vector/assets/lib/data/us-unemployment.json', function(data){
			var val = 2009;
	...
	{
		$.getJSON( componentsPath + 'maps/vector/assets/lib/data/france-elections.json', function(data){
			new jvm.WorldMap({
				map: 'fr_merc_en',
