...
function initScripts()
{
	...
	var $scripts = [
        componentsPath + "maps/google/assets/lib/jquery-ui-map/ui/jquery.ui.map.js",
        componentsPath + "maps/google/assets/lib/jquery-ui-map/ui/jquery.ui.map.extensions.js",
        componentsPath + "maps/google/assets/lib/jquery-ui-map/ui/jquery.ui.map.services.js",
        componentsPath + "maps/google/assets/lib/jquery-ui-map/ui/jquery.ui.map.microformat.js",
        componentsPath + "maps/google/assets/lib/jquery-ui-map/addons/markerclustererplus/markerclusterer.min.js"
    ];
...
function initGoogleMaps()
{
	...
	if ($('#google-map-json').length)
	{
		$('#google-map-json').gmap().bind('init', function() { 
			$.getJSON( componentsPath + 'maps/google/assets/lib/jquery-ui-map/data/demo.json', function(data) { 
