...
<script type="text/javascript">
 function generate(){
    ...
    if (grado == '')  { 
        ...
        document.getElementById('generator').href = '/reports/schedulesreport?grado='+grado;
    };
...
<form class="form-horizontal margin-none" id="validateSubmitForm" action="" method="post" role="form">
    ...
    <div class="widget widget-heading-simple widget-body-white">
        ...
        <div class="widget-head-white">
            <h3 class="pull-left">Generar Horario</h3> <?php if (Auth::user()->user_level == 1 || Auth::user()->user_level == 2) { ?><a class ="pull-right" href="{{ action('ReportController@view') }}"><span class="btn btn-primary btn-icon glyphicons left_arrow pull-right"><i></i>Regresar</span></a><?php } ?>
        </div>
        </br>
