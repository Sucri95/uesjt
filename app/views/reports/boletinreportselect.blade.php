...
function periodyear() {
 ...
 $("#select2_11").parent("div").find("ul > li").remove();
  ...
  $.get("/reports/ajaxperiod","rep="+o, function(respuesta){
...
<form class="form-horizontal margin-none" id="validateSubmitForm" action="" method="post" role="form">
    ...
    <div class="widget widget-heading-simple widget-body-white">
        ...
        <div class="widget-head-white">
            <h3 class="pull-left">Generar Bolet&iacute;n</h3> <a class ="pull-right" href="{{ action('ReportController@view') }}"><span class="btn btn-primary btn-icon glyphicons left_arrow pull-right"><i></i>Regresar</span></a>
        </div>
        </br>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group pull-center">
                       ...
                       <div class="col-md-8"><select  style="width: 100%;" data-style="btn-default btn-small" id="select2_11" name="lapso" onChange="generate()">
