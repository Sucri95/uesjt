  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">  
            <h4 class="modal-title" id="exampleModalLabel">¿Desea guardar los cambios realizados?</h4>
          <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">NO</button>
        <a onclick="document.getElementById('form-updatecalification').submit();" class="btn btn-primary" >GUARDAR</a>
      </div>
...
<form id="form-updatecalification" class="form-horizontal margin-none" id="validateSubmitForm" action="{{ action('CalificationController@editor') }}" method="post" role="form">
    ...
    <div class="widget widget-heading-simple widget-body-white col-md-10">
        ...
        <div class="widget-head">
            <h2 class="pull-left">Actualizar notas de {{ $student->name }} {{ $student->lastname }} en {{ $materia->name_sub }}</h2><a class ="pull-right" href="/califications/indexsubjet?id={{$student->id}}&idgrado={{$grado->id}}"><span class="btn btn-primary btn-icon glyphicons left_arrow pull-right"><i></i>Regresar</span></a>
        </div>
        </br>
        <!-- // Widget heading END -->
            ...
            <div class="row">
                ...
                <input type="hidden" id="id_grado" value="{{ $grado->id }}"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8"><input class="form-control center" id="name" name="name" value="{{ $student->name }}" type="text" readonly /></div>
                    </div>

                    <div class="form-group">
                        <label class="col-md-4 control-label">Apellido:</label>
                        <div class="col-md-8"><input class="form-control center" id="lastname" name="lastname" value="{{ $student->lastname }}" type="text" readonly /></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8"><select id="select2_14" style="width:100%" data-style="btn-default btn-small" name="continue_eval"/>        
                        </select></div>
                    </div>

                    <div class="form-group">
                        <label class="col-md-4 control-label">Calificaci&oacute;n Cualitativa:</label>
                        <div class="col-md-8"><select id="select2_15" style="width:100%" data-style="btn-default btn-small" name="cualitative"/>           
                        </select></div>
                    </div>

                    <div class="form-group">
                        <label class="col-md-4 control-label">Calificaci&oacute;n Numeral:</label>
                        <div class="col-md-8"><select id="select2_16" style="width:100%" data-style="btn-default btn-small" name="cuantitative"/>               
                        </select></div>
                    </div>
            </div>
